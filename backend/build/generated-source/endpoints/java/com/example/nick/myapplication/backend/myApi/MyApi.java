...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class MyEndpoint {
    ...
    /**
     * Create a request for the method "myEndpoint.setJoke".
     *
     ...
     * @return the request
     */
    public SetJoke setJoke(java.lang.String joke) throws java.io.IOException {
      SetJoke result = new SetJoke(joke);
      initialize(result);
      return result;
    }

    public class SetJoke extends MyApiRequest<Void> {

      private static final String REST_PATH = "setJoke/{joke}";
       ...
       * @since 1.13
       */
      protected SetJoke(java.lang.String joke) {
  ...
  public class GetJoke extends MyApiRequest<com.example.nick.myapplication.backend.myApi.model.Joke> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.nick.myapplication.backend.myApi.model.Joke.class);
    }
